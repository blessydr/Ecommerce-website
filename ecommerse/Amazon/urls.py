...
from .views import RegisterUserView,LoginView,LogoutView,ProductListView,WishlistView,ProductDetailView,RatingDetailView,RatingListCreateView,CartListView,AddToCartView
